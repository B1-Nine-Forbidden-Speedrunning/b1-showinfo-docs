<template>
  <div id="live2d" ref="live2dRef" :style="{
    position: 'fixed',
    ...
    <canvas v-if="live2dOptions.enable" id="live2dCanvasElement" :style="{
      position: 'absolute',
      left: '0',
      top: '0'
    }" class="live2dCanvasElement" :width="stripPX(live2dOptions.display.width)"
      :height="stripPX(live2dOptions.display.height)"></canvas>
  </div>
</template>
